...
-(void)checkRssData {
  ...
  STAssertEqualStrings(@"http://www.eweek.com/c/a/Search-Engines/Verizon-"
                       @"Picks-Microsoft-Search-over-Google-Yahoo/",
                       [firstItem url],
  ...
  STAssertEqualObjects([NSDate dateWithNaturalLanguageString:
                        @"Wed, 07 Jan 2009 23:31:25 GMT"],
                       [secondItem date],
